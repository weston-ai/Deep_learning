...
#Import dataset
df=pd.read_csv("/datasets/my_custom_datasets/hypertension_study_main_20250408.csv", na_values=[""])
# df.shape (445061; 27)
...
# Set system path, allowing us to import functions from py_utils
sys.path.append("/home/cweston1/miniconda3/envs/PythonProject/py_scripts/deep_learning_scripts/pytorch_scripts/multilayer_perceptron_MLP/hypertension/")
...
### ============================================================================================================
### 2E: Function to reconstruct the model architecture (to obtain metadata that can be matched with weights)
### ============================================================================================================
...
### ====================================================================================
### 2F: Function to test the best performant training model on holdout test data
### ====================================================================================
...
### =====================================================================================
### 2G: Function to prepare HTML template (this is for rendering and saving the HTML)
### =====================================================================================
...
import json
from py_utils import clean_json_compatible
...
#################################################################################
#######    4: REPORTING: Generate HTML and PDF reports of experiment     ########
#################################################################################
...
# Delete saved files (images, json, etc) if you want to prevent the hyperaccumulation of files in the subdirectories. YOU MUST UNCOMMENT THE CALL TO THE "delete_files_in_directories" FUNCTION BELOW.
